...
<head>
    ...
    <title>Danh sách nhân viên thuộc lịch làm việc Tháng 4</title>
    ...
    <div class="d-quan-ly-cty">
        ...
        <div class="d-quan-ly-cty1">
            ...
            <div class="d-qly-cty1-v1">
                <h3 class="d-qly-cham-cong">Danh sách nhân viên thuộc lịch làm việc Tháng 4</h3>
                <div class="d-qly-cham-cong1">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <input type="text" class="d-ds-nv-input" placeholder="Nhập từ khóa">
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12 d-ds-cty-con3">
                            <a href="/danh-cho-cong-ty/them-nhan-vien.html" class="d-ds-cty-con3-1 d-ds-ca-lam">Thêm nhân viên</a>
                        </div>
                    </div>
                ...
                <div class="modal-content d-modal-bo-loc1">
                    ...
                    <form method="post" class="d-form-them-cty" id="sua_llv">
                        <div class="d-fomr-them-cty1">
                            <select name="" id="chon_llv" class="d-llv-nv">
