...
<div class="q-gioithieu-content">
    <div class="q-gioithieu-download">
        <div class="q-gioithieu-download-v2">
            <div class="q-gioithieu-download-phone"></div>
            <div class="q-gioithieu-download-div">
                <p class="q-gioithieu-download-div-title">Tải App Ngay Hôm Nay Để Được Sử Dụng Công Nghệ Chấm Công Mới Nhất</p>
                <div class="q-gioithieu-download-div-button">
                    <a href="">
                        <div class="q-gioithieu-download-button">
                            <img src="<?= base_url() ?>assets/images/gplay.png" alt="ggplay">
                            <p>Google Play</p>
                        </div>
                    </a>
                    <a href="">
    ...
    <!-- <div class="q-content-p q-gioithieu-p">
        <p>Bước tiến mạnh mẽ của công nghệ số đã và đang thay đổi một cách ngoạn
        ...
        <div class="q-content-p-title" id="hide_on_mobile">
            <span>
