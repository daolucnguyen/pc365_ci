        ...
        <div class="q-content-body">
            <div class="q-qmk">
                ...
                <form class="q-qmk-form">
                    ...
                    <input type="text" name="qmk_email" class="q-qmk-form-input input_email_2" placeholder="Nhập email của bạn">
                    <p class="val_error" id="val_qmk1"></p>
                    <button type="submit" class="q-qmk-form-button send_mail_forgot_pass"><span>Gửi Email Xác Thực</span></button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="q-qmk-2">
                    ...
                    <form class="q-qmk-form-2">
                        ...
                        <div class="q-qmk-form-footer-2">
                            <p >Không nhận được mã ? <p class="l_curson" onclick="retypeMail();" id="re-send">Gửi lại</p></p>
                        </div>
                        <div class="q-qmk-form-button-2">
                                    ...
                                    <a href="/quen-mat-khau-nhan-vien.html" class="q-qmk-button1" id="input-reform-2"><span>Quay Lại</span></span></a>
