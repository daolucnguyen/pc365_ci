...
<body>
    <div class="d-quan-ly-cty">
        ...
        <div class="d-quan-ly-cty1">
            ...
            <div class="d-qly-cty1-v1">
                <h3 class="d-qly-cham-cong">Danh sách nhân viên</h3>
                <div id="alert"></div>
                <div class="d-qly-cham-cong1">
                    <div class="row">
                        <form action="" onsubmit="timkiem(<?= $id_calendar ?>); return false;">
                            <div class="col-md-6 col-sm-8 col-xs-8">
                                <input type="text" id="keyWord" class="d-ds-nv-input" placeholder="Nhập từ khóa">
                            </div>
                            <div class="col-md-2 col-sm-4 l_text_right">
                                <button class="btn_search l_clear_margin " type="button" onclick="timkiem(<?= $id_calendar ?>); return false;">tìm kiếm</button>
                            </div>
                        </form>
                        <div class="col-md-3 col-sm-12 col-xs-12 d-ds-cty-con3">
                            <a href="<?= urlThemNvvaoLichLamViec(); ?>?id_calendar=<?= $id_calendar ?>" class="d-ds-cty-con3-1 d-ds-ca-lam">Thêm nhân viên</a>
                        </div>
                    </div>
                                                ...
                                                <td class="d-table-td">
                                                    <div class="d-info-nv">
                                                        ...
                                                        <div class="d-cham-cong-td1a">
                                                            ...
                                                            <p class="d-cham-cong-p1">Nhân viên phòng
                                                                <?
                                                                $count = 0;
                                ...
                                ?>
                                    <div class="d-ds-nv-mobile">
                                        ...
                                        <div class="d-email-nv-mobie">
                                            <p class="d-ds-nv-co-lich"><?= $value['name_calendar'] ?></p>
                                        </div>
                    ...
                    <form method="post" class="d-form-them-cty" id="sua_llv">
                        <div class="d-fomr-them-cty1">
                            ...
                            <select name="chon_llv" id="chon_llv" class="d-llv-nv">
                                ...
                                ?>
                                    <option value="<?= $value['id'] ?>">Tháng <?= $value['name_calendar']; ?></option>
                                <?
                                }
                                ?>
                            </select>
    ...
    <script>
        ...
        function timkiem(id) {
            ...
            if (keyWord != '' && id != '') {
                window.location.href = base_url + '/danh-sach-nhan-vien-co-lich.html?id_calendar=' + id +'&keyWord=' + keyWord;
            }  else if (keyWord == '' && id != '') {
                window.location.href = base_url + '/danh-sach-nhan-vien-co-lich.html?id_calendar=' + id;
            }
        }
    </script>
</body>
