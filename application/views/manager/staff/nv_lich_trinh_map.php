...
<body>
                        ...
                        <div class="q-right-content-map">
                            <div class="q-content-map-header">
                                <div class="q-content-map-header-avatar">
                                    <img id="map_header_avatar" src="<?= base_url() ?>assets/images/content-row2-div1.png" alt="avatar">
                                </div>
                            ...
                            <div class="q-content-map-control">
                                <a href="" class="q-content-map-control-v2" id="map_control_delete">
                                    <img src="<?= base_url() ?>assets/images/delete-map.png" alt="delete" class="q-content-map-control-img">
                                    <p class="q-content-map-control-link">Xóa</p>
                                </a>
                                <a href class="q-content-map-control-v2" id="map_control_edit">
                                    <img src="<?= base_url() ?>assets/images/edit.png" alt="edit" class="q-content-map-control-img">
                            ...
                            <div class="q-content-map-info">
                                ...
                                <div class="q-content-map-step">
                                    <div class="q-content-map-step-left">
                                        <img src="<?= base_url() ?>assets/images/map_checked.png" alt="checked" class="q-content-map-step-img" id="map_check_1">
                                        <img src="<?= base_url() ?>assets/images/map_line_checked.png" alt="line" class="q-content-map-step-line" id="line_1">
                                        <img src="<?= base_url() ?>assets/images/map_checked.png" alt="checked" class="q-content-map-step-img" id="map_check_2">
                                        <img src="<?= base_url() ?>assets/images/map_line_check.png" alt="line" class="q-content-map-step-line" id="line_2">
                                        <img src="<?= base_url() ?>assets/images/map_check.png" alt="checked" class="q-content-map-step-img" id="map_check_3">
                                        <img src="<?= base_url() ?>assets/images/map_line_check.png" alt="line" class="q-content-map-step-line" id="line_2">
                                        <img src="<?= base_url() ?>assets/images/map_check.png" alt="checked" class="q-content-map-step-img" id="map_check_3">
                                    </div>
                                    <div class="q-content-map-step-right">
                                        <div class="q-content-map-step-right-v2">
                                            <div class="q-content-map-step-row">
                                                ...
                                                <img src="<?= base_url() ?>assets/images/map_delete.png" alt="delete" class="q-content-map-step-cancel hide">
                                            </div>
                            ...
                            <div class="q-content-map-footer">
                                ...
                                <div class="q-content-map-footer-v2">
                                    <div class="q-content-map-footer-avatar">
                                        <img src="<?= base_url() ?>assets/images/app_cv365.png" alt="avatar" id="map_dh_1">
                                        <img src="<?= base_url() ?>assets/images/app_cv365.png" alt="avatar" id="map_dh_2">
                                        <img src="<?= base_url() ?>assets/images/app_cv365.png" alt="avatar" id="map_dh_3">
                                        <div id="map_dh_4">
                                            <p id="map_count">5</p>+
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#menu_scan').attr('src','<?= base_url() ?>assets/images/Scan.png');
            $('#menu_location').attr('src','<?= base_url() ?>assets/images/Location-active.png');

            $('#menu_cat_drop').attr('src','<?= base_url() ?>assets/images/Category.png');
            $('#menu_scan_drop').attr('src','<?= base_url() ?>assets/images/Scan.png');
            $('#menu_location_drop').attr('src','<?= base_url() ?>assets/images/Location-active.png');
