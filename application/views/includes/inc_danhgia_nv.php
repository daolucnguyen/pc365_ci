...
<div id="modal_danhgia_nv" class="modal fade q-modal-danhgia" role="dialog">
        ...
        <div class="modal-content q-modal-danhgia-content">
            ...
            <form action="">
                <div class="modal-body q-modal-body-danhgia">
                    ...
                    <textarea style="resize: none;" name="" id="note_nv" cols="30" rows="10" class="q-modal-danhgia-input" placeholder="Hãy cho chúng tôi biết cảm nghĩ của bạn về ứng dụng"></textarea>
                    ...
                    <div class="q-modal-footer-button-div">
                        ...
                        <button type="button" onclick="danhGiaNv();" class="q-modal-footer-button">Đánh Giá</button>
                        <!-- data-dismiss="modal" -->
                    </div>
                </div>
            </form>
