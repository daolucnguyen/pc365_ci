<div class="d-qly-cham-cong1-v1">
    <div class="col-md-6 col-sm-12 col-xs-12 d-qly-cham-cong1-v1a">
        <input type="text" value="" id="search" name="search" class="d-qly-cham-cong1-v1a-input" placeholder="Nhập từ khóa">
    </div>
    <div class="col-md-3 d-qly-cham-cong1-v1a1" id="d-qly-cham-cong1-v1a1">
        <input type="date" value="" id="search" name="search" class="d-qly-cham-cong1-v1a-input">
    </div>
    <div class="col-md-3 d-qly-cham-cong1-v1a2" id="d-qly-cham-cong1-v1a2">
        <input type="date" value="" id="search" name="search" class="d-qly-cham-cong1-v1a-input">
    </div>
</div>
<div class="d-qly-cham-cong1-v2">
    <div class="col-md-4 d-qly-cham-cong1-v1a d-qly-cham-cong-tab">
        <select name="chi_nhanh" id="chi_nhanh" class="d-chi-nhanh">
