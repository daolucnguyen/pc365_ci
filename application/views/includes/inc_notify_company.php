<div class="l_staff_notify">
    <div class="height_notify">
        ...
        ?>
            <div class="l_flex l_justify l_delete" id="notify<?= $value['id_notify'] ?>" data-id="<?= $value['id_notify'] ?>">
                ...
                <div class="l_notify_item2">
                    <p class="l_notify_content"><?= $value['note']; ?> (<?= date('d-m-Y',$value['date']) ?>)</p>
                </div>
            </div>
        <?
        }
    ...
    <div class="l_flex l_justify l_delete_notify">
        <span class="l_delete_notify_item l_curson" onclick="deleteNotifyCompany();">
            Xóa hết tất cả
        </span>
    </div>
</div>